...
async function v1(server, server_request) {
    ...
    const {
        ...
        remote,
        headers
    } = read_headers(server_request, server_request.headers);
    ...
    response_headers['x-bare-headers'] = JSON.stringify(mapHeadersFromArray(rawHeaderNames(response.rawHeaders), {
        ...response.headers
    }));
